...
$_SESSION['msg1']="La contraseña se cambió satisfactoriamente";
}
else
{
...
{
alert("No has ingresado tu contraseña actual");
document.chngpwd.cpass.focus();
return false;
}
else if(document.chngpwd.npass.value=="")
{
alert("No has ingresado tu nueva contraseña");
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Administrador | Cambiar contraseña</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
