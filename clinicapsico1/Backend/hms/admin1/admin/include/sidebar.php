								...
								<ul class="sub-menu">
									<li>
										<a href="doctor-specilization.php">
											<span class="title"> Especialización del doctor </span>
										</a>
									</li>
									<li>
	...
	<li>
								<a href="doctor-logs.php">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Historial de sesiones de doctor </span>
										</div>
									</div>
								</a>
							</li>		
							...
							<li>
								<a href="user-logs.php">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Historial de sesiones de usuario </span>
										</div>
									</div>
								</a>
							</li>						
