...
$_SESSION['msg1']="Contraseña cambiada";
}
else
{
$_SESSION['msg1']="Contraseña antigua erronea";
}
}
?>
<!DOCTYPE html>
...
{
alert("Contraseña actual vacía");
document.chngpwd.cpass.focus();
return false;
}
else if(document.chngpwd.npass.value=="")
{
alert("Nueva contraseña vacía");
document.chngpwd.npass.focus();
return false;
}
else if(document.chngpwd.cfpass.value=="")
{
alert("Confirmar nueva contrasea vacía");
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<div class="container-fluid container-fullw bg-white">
							...
							<input type="password" name="cpass" class="form-control"  placeholder="Ingresa la contraseña actual">
														</div>
														<div class="form-group">
