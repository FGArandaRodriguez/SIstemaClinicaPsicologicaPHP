...
if($sql)
{
echo "<script>alert('Detalles de doctor actualizados');</script>";
...
<html lang="en">
	<head>
		<title>Doctorr | Editar detalles de Doctor</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Doctor | Editar detalles de Doctor</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Doctor</span>
...
<div class="form-group">
															<label for="address">
																 Dirección de clínica de Doctor
															</label>
					<textarea name="clinicaddress" class="form-control"><?php echo htmlentities($data['address']);?></textarea>
														</div>
<div class="form-group">
															<label for="fess">
																 Consultar cuotas de Doctor
															</label>
