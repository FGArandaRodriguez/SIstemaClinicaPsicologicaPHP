...
<html lang="en">
	<head>
		<title>Administrador | Especialización del Doctor </title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Administrador | Agregar especialización del Doctor</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
...
?>
	...
	<a href="doctor-specilization.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('¿Estás seguro que deseas eliminarlo?')"class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove"><i class="fa fa-times fa fa-white"></i></a>
												</div>
