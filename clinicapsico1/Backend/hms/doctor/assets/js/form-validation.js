    ...
    var runValidator1 = function () {
        ...
        $('#form').validate({
            ...
            messages: {
                ...
                lastname: "Por favor Especifique sus apellidos",
                email: {
                    required: "Necesitamos su Email Para contactarlo",
                    email: "Su Email debe estar en formato name@domain.com"
                },
                gender: "Por favor Eliga su género!"
            },
    ...
    var runValidator2 = function () {
        ...
        form2.validate({
            ...
            messages: {
                ...
                services: {
                    minlength: jQuery.validator.format("Plor favor seleccione al menos {0} tipo de Servicio")
                }
            },
            invalidHandler: function (event, validator) { //display error alert on form submit
