...
if($query)
{
	echo "<script>alert('Registro compeleto, ya puedes iniciar sesión');</script>";
}
}
?>
				...
				<div class="box-register">
					<form name="registration" id="registration"  method="post">
						<fieldset>
							...
							<p>
								Ingresa tu información personal abajo:
							</p>
							...
							<p>
								Ingresa la información de tu cuenta abajo:
							</p>
							<div class="form-group">
							...
							<div class="form-group">
								<span class="input-icon">
									<input type="password" class="form-control" name="password_again" placeholder="Confirma tu contraseña" required>
									<i class="fa fa-lock"></i> </span>
							</div>
							<div class="form-group">
