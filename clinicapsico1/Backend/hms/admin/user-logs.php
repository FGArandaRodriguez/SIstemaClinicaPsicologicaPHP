...
<html lang="en">
	<head>
		<title>Administrador | Detalles de sesión de usuario</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Administrador  | Detalles de sesión de usuario</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
									...
									<li class="active">
										<span>Detalles de sesión de usuario</span>
									</li>
								</ol>
							</div>
						</section>
